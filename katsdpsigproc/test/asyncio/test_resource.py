...
class TestResource(object):
    ...
    def test_wait_events(self):
        ...
        run1 = asyncio.async(self._run_frame(a1, e1), loop=self.loop)
        run0 = asyncio.async(self._run_frame(a0, e0), loop=self.loop)
        yield from(run0)
        yield from(run1)
        order = []
        try:
...
class TestJobQueue(object):
    ...
    def test_finish(self):
        ...
        finisher = asyncio.async(self._finish(), loop=self.loop)
