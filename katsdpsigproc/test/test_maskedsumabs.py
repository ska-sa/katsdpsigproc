...
from .. import accel
from .. import maskedsumabs

class TestMaskedSumAbs(object):
    def test_maskedsumabs(self):
        yield self.check_maskedsumabs, 4096, 2
        yield self.check_maskedsumabs, 4096, 4029
        yield self.check_maskedsumabs, 4096, 4030
        yield self.check_maskedsumabs, 4096, 4031
        yield self.check_maskedsumabs, 4096, 4032
    ...
    @device_test
    def check_maskedsumabs(self, R, C, context, queue):
        template = maskedsumabs.MaskedSumAbsTemplate(context)
    ...
    def test_autotune(self, context, queue):
        ...
        maskedsumabs.MaskedSumAbsTemplate(context)
